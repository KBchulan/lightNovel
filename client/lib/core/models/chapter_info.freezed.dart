...
class _$ChapterInfoImpl implements _ChapterInfo {
  ...
  @override
  String toString() {
    return 'ChapterInfo(id: $id, novelId: $novelId, volumeNumber: $volumeNumber, chapterNumber: $chapterNumber, title: $title, createdAt: $createdAt, updatedAt: $updatedAt)';
  }
  ...
  int get hashCode => Object.hash(runtimeType, id, novelId, volumeNumber,
      chapterNumber, title, createdAt, updatedAt);
...
abstract class _ChapterInfo implements ChapterInfo {
  const factory _ChapterInfo(
      ...
      required final DateTime updatedAt}) = _$ChapterInfoImpl;
